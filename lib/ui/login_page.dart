...
class _LoginPageState extends State<LoginPage>
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Icon(FontAwesomeIcons.magento, size: 300, color: Color.fromRGBO(110, 33, 66, 0.85),)
                    ),
                    Padding(
  ...
  void _validateAndSubmitLogin(TextEditingController emailLogin,
      TextEditingController passwordLogin) async {
    if (_validateAndSaveSignIn()) {
      String userId = "";
      try {
        print(emailLogin.text);
        print(passwordLogin.text);
        FirebaseUser user = await authService.signInWithCredentials(
            emailLogin.text, passwordLogin.text);
  ...
  void saveUserInDB(FirebaseUser user) {
    String url = "https://medapromo.herokuapp.com/user";

    Map<String, String> body = {'uid': user.uid, 'nome': user.displayName};
  ...
  Widget _buildMenuBar(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color.fromRGBO(110, 33, 66, 0.85),
                  ...
                  Container(
                    ...
                    child: MaterialButton(
                        ...
                        onPressed: () => _validateAndSubmitLogin(
                            loginEmailController, loginPasswordController)),
                  ),
                ],
              ),
              Padding(
            ...
            children: <Widget>[
              Stack(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              onSaved: (value) =>
                                  signupNameController.text = value,
                            ),
                          ),
                          Container(
                            width: 250.0,
                ...
                child: Row(
                  ...
                  Container(
                    margin: prefix0.EdgeInsets.only(top: 380),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Padding(
